...
public class Chat2 extends AppCompatActivity {
    ...
    Handler handler;
    long mBackPressed;
    int BOT_BEGIN = 0, BOT_CONTINUE = 1, USER_MSG = 2, BOT_END = 3;
    @Override
            ...
            public void handleMessage(Message msg) {
                switch(msg.what){
                    ...
                    case 1:
                        ...
                        chatListAdapter.notifyDataSetChanged();
                        result.setAdapter(chatListAdapter);
                        result.setSelection(ListView.FOCUS_DOWN);
                        break;
                    case 2:
                        // User' msg
                        CloseInputMethod(Chat2.this);
                        if(history.size() >= mApi.max_history){
                            history.remove(0);
                            history.remove(0);
                        }
                        Log.e("H", history.toString());
    ...
    ArrayList<Spinner> initConfigs(View view){
    ...
    void SetSpinnerAdapter(Spinner sp, ArrayList<?> arrayList, int flag){
        ...
        switch (flag){
            case 0:
                ...
                Log.e("V", String.valueOf(sp.getSelectedItem()));
